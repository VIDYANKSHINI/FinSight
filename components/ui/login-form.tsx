...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md p-10 md:p-12 space-y-8 bg-white/10 backdrop-blur-lg rounded-[32px] border border-white/20 shadow-2xl">
      ...
      <form className="space-y-8">
        ...
        <div className="relative z-0">
          <input
            type="email"
            id="floating_email"
            className="block py-3 px-0 w-full text-base text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-500 peer"
            placeholder=" " 
            required
          />
          <label
            htmlFor="floating_email"
            className="absolute text-base text-gray-300 duration-300 transform -translate-y-7 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7"
          >
        ...
        <div className="flex items-center justify-between">
          <a href="#" className="text-sm text-gray-300 hover:text-white transition">Forgot Password?</a>
        </div>
        ...
        <button
          ...
          className="group w-full flex items-center justify-center py-3.5 px-4 bg-blue-600 hover:bg-blue-700 rounded-xl text-white text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 transition-all duration-300 shadow-lg shadow-blue-500/30"
        >
          Sign In
        ...
        <div className="relative flex py-3 items-center">
            ...
            <span className="flex-shrink mx-4 text-gray-400 text-sm font-medium tracking-wider">OR CONTINUE WITH</span>
            <div className="flex-grow border-t border-gray-400/30"></div>
        </div>
        ...
        <button
          type="button"
          onClick={() => signIn("google", { callbackUrl: "/onboarding/user-type" })}
          className="w-full flex items-center justify-center py-3 px-4 bg-white/90 hover:bg-white rounded-xl text-gray-700 text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 transition-all duration-300 shadow-xl"
        >
