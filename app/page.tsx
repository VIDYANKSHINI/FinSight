...
export default function TerraPage() {
  ...
  const dynamicWords = ["cash flow", "revenue", "risks", "expenses", "trends", "seasonality", "eligibility"]
        ...
        >
          <div className="text-center mb-8 md:mb-12">
            <h1 className="font-serif text-[44px] leading-[1.1] md:text-[72px] md:leading-[1.05] font-medium mb-6 text-balance">
              ...
              >
                Predict <AnimatedText key={dynamicWordIndex} text={dynamicWords[dynamicWordIndex]} delay={0} />
              </span>
            ...
            >
              FinSightAI empowers rural micro-enterprises and financial institutions with AI-driven cash flow
              forecasting, early risk detection, and alternative data-based financial assessment.
            </p>
            <div
              className="stagger-reveal flex flex-col sm:flex-row items-center justify-center gap-4"
      ...
      <section className="relative py-12 border-y border-white/5 bg-[#0B0C0F] overflow-hidden md:py-8 md:pt-8 md:pb-4">
        <div className="w-full">
          <p className="text-center text-xs md:text-sm uppercase tracking-[0.2em] text-[#A7ABB3] mb-8">
            Trusted by leading financial institutions and lenders
          </p>
      ...
      <section id="metrics" className="relative py-20 md:py-32 px-4 animate-on-scroll md:pt-24 md:pb-20">
        <div className="max-w-[1120px] w-full mx-auto">
          ...
          <p className="text-[#A7ABB3] text-sm md:text-base mb-12 md:mb-16 text-center max-w-[600px] mx-auto leading-relaxed">
            Trusted by financial institutions and rural enterprises. Powered by AI-driven intelligence.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 max-w-[800px] mx-auto">
            {[
              { label: "PREDICTION ACCURACY", value: "95%", desc: "cash flow forecasts", color: "pink" },
              { label: "FASTER ASSESSMENT", value: "80%", desc: "loan processing", color: "purple" },
              { label: "EARLY RISK DETECTION", value: "70%", desc: "risks caught early", color: "pink" },
              { label: "BUSINESSES SUPPORTED", value: "10K+", desc: "and growing", color: "purple" },
            ].map((metric, i) => (
              <div
                key={i}
      ...
      <section id="map" className="relative py-20 md:py-32 animate-on-scroll bg-[#0B0C0F]">
        <div className="text-center mb-12 md:mb-16 px-4">
          ...
          <h2 className="font-serif text-[32px] leading-[1.15] md:text-[48px] md:leading-[1.1] font-medium mb-6 text-balance">
            Empowering Micro-Enterprises Everywhere
          </h2>
          <p className="text-[#A7ABB3] text-sm md:text-base max-w-[600px] mx-auto leading-relaxed">
            Bringing AI-driven financial intelligence to rural businesses and lenders across regions
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-stretch">
            <div className="max-w-[720px]">
              ...
              <p className="text-[#A7ABB3] text-base md:text-lg leading-relaxed mb-12">
                Our AI analyzes UPI transactions, sales records, weather conditions, and seasonal trends to forecast cash
                flow, detect risks early, and improve loan eligibility with transparent, explainable insights.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Predict business cash flow for the next 30, 60, and 90 days using machine learning",
                    icon: CustomDroneIcon,
                    image: "/drone.png",
                  },
                  {
                    title: "Financial Health Score",
                    desc: "AI-powered score measuring business stability and loan readiness",
                    icon: Satellite,
                    image: "/real-time-satellite.png",
                  },
                  {
                    title: "Early Risk Detection",
                    desc: "Identify cash shortages, declining revenue, and repayment issues before they escalate",
                    icon: PawPrint,
                    image: "/biodiversity-tracking.png",
                  },
                  {
                    title: "Alternative Data Intelligence",
                    desc: "Analyze UPI transactions, sales, weather, and seasonal trends beyond financial statements",
                    icon: Trees,
      ...
      <section id="faq" className="relative py-20 md:py-32 px-4 animate-on-scroll">
        <div className="max-w-[800px] w-full mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-[#A7ABB3] text-sm md:text-base max-w-[600px] mx-auto leading-relaxed">
              Everything you need to know about FinSightAI and our financial intelligence platform.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              {
                question: "How does FinSightAI predict cash flow?",
                answer:
                  "Our platform uses machine learning to analyze UPI transactions, sales records, weather conditions, commodity prices, and seasonal trends. This lets us forecast business cash flow for the next 30, 60, and 90 days with high accuracy.",
              },
              {
                question: "What data does FinSightAI use for assessment?",
                answer:
                  "Instead of relying only on traditional financial statements, FinSightAI leverages alternative data such as UPI transactions, sales history, weather conditions, market intelligence, and seasonal trends to build a complete picture of business health.",
              },
              {
                question: "How accurate is the cash flow prediction?",
                answer:
                  "Our AI models achieve up to 95% cash flow prediction accuracy. We continuously train on real transaction and market data to distinguish seasonal fluctuations from genuine financial risks.",
              },
              {
                question: "Can financial institutions integrate FinSightAI?",
                answer:
                  "Yes, FinSightAI offers a lender dashboard and API that integrate with existing loan management and credit assessment systems, enabling faster, smarter, and more inclusive lending decisions.",
              },
              {
                question: "How does the Financial Health Score work?",
                answer:
                  "We generate an AI-powered score that measures business stability and loan readiness. Every score comes with explainable AI insights and confidence levels so you understand exactly why each prediction was made.",
              },
              {
                question: "How can rural businesses get started?",
                answer:
                  "Rural micro-enterprises can start a free assessment by connecting their transaction and sales data. FinSightAI then delivers instant cash flow forecasts, risk alerts, and personalized recommendations to improve financial health.",
              },
            ].map((faq, i) => (
              <div
                key={i}
      ...
      >
        ...
        <div className="max-w-[800px] w-full mx-auto text-center relative z-10">
          ...
          <h2 className="font-serif text-[40px] leading-[1.15] md:text-[64px] md:leading-[1.1] font-medium mb-6 text-balance">
            Ready to transform rural financial decision-making?
          </h2>
          <p className="text-[#A7ABB3] text-base md:text-lg mb-10 leading-relaxed max-w-[560px] mx-auto">
            Empower rural businesses with AI-driven cash flow prediction and help financial institutions make faster,
            smarter, and more inclusive credit decisions.
          </p>
        ...
        <div className="max-w-[1120px] w-full mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
            ...
            <div className="flex flex-col gap-4">
              <div className="text-lg font-semibold font-mono">FinSightAI</div>
              <p className="text-xs text-[#A7ABB3] leading-relaxed">
                Empowering rural businesses with AI-driven financial intelligence.
              </p>
            ...
            {/* Product Menu */}
            <div className="flex flex-col gap-4">
              <div className="text-xs uppercase tracking-[0.15em] text-[#F2F3F5] font-semibold mb-2">Solutions</div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs text-[#A7ABB3] mb-3">Get updates on financial insights and product news.</p>
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#A7ABB3]">
            <div>© 2026 FinSightAI. All Rights Reserved.</div>
